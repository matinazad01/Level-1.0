...
frame.setVisible(true);
		...
		JPanel head;
		head = createHeader("17th centuary military tactics");
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton button1 = new JButton(dollarAmount);
...
playJeopardyTheme();
		...
		buttonPressed=firstButton;
			...
			askQuestion("How many push-ups did horses have to do to join the military", "45", 200);
	...
	String question1 = JOptionPane.showInputDialog();
