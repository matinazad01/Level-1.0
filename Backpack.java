...
Pencil hb2 = new Pencil();
Ruler steel = new Ruler();
Textbook whateverButHistoryPlease = new Textbook();
jansport.putInBackpack(whateverButHistoryPlease);
jansport.putInBackpack(steel);
jansport.putInBackpack(hb2);
jansport.goToSchool();
